...
def main():
    ...
    logger.debug("Maskiertes Secret: %s", mask_secret(secret))
    logger.warning("Das ist nur ein Test-Warning")
    logger.error("Das ist ein Test-Error")
